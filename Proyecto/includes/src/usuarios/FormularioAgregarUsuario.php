...
class FormularioAgregarUsuario extends Formulario {
    public function __construct() {
        parent::__construct('formAddUser', ['urlRedireccion' => 'adminUsuarios.php']);
    }
    ...
    protected function generaCamposFormulario(&$datos)
    {
        ...
        <fieldset class="formulario">
            ...
            <select name="type" id="type">
                ...
                <option value="2" . ('selected' : '') . >Comerciante</option>
        ...
        if (count($this->errores) === 0) {
           ...
           $usuario=usuarioDAO::searchLogin($nombreUsuario);
            ...
            if ($usuario) {
               ...
               $usuario= usuarioDAO::addUser($nombre,$apellidos,$correo,$direccion,$telefono,$dni,$nombreUsuario,$password, $type);
            }
        }
    }
}
