...
if ($app->esComerciante() == false) {
	Aplicacion::paginaError(403, $tituloPagina, '¡Acceso Denegado!', 'No tienes permisos suficientes para acceder al panel de comerciante de la web.');
}
