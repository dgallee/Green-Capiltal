...
para macetas o parterres.', 4.99, 'Dahlia', 22, 'Dahlia', 'img/dahlia.png'),
...
directamente.', 5.99, 'Margarita', 18, 'Dimorfoteca', 'img/margarita-dimorfoteca.png'),
...
hasta la más pequeña. En invierno, debemos protegerlo de las heladas.', 3.99, 'Geranio', 18, 'Geranio', 'img/geranio.png'),
...
pertenece a la familia de la liláceas.', 3.99, 'Muscari', 20, 'Muscari', 'img/muscari.png'),
...
numerosas. Son plantas muy aromáticas y pueden cambiar su olor según la especie.', 4.49, 'Orquidea', 24, 'Orquidea', 'img/orquidea.png'),
...
primeros calores, la planta decae.', 2.99, 'Pensamiento', 32, 'Pensamiento', 'img/pensamiento.png');